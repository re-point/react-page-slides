...
export class ManualSlidesContainer extends React.PureComponent<
  IManualSlidesContainerProps,
  IManualSlidesContainerState
> {
  static defaultProps = {
  ...
  static isValidSlideIndex(
    slideIndex: number,
    props: IManualSlidesContainerProps
  ) {
    ...
    this.container.addEventListener("scroll", (event) => {
      ...
      if (!this.props.enableAutoScroll && target) {
        const currentSlideIndex = Math.ceil(
          target.scrollTop / this.getHeight()
        );
