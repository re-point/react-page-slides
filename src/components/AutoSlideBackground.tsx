...
export class AutoSlideBackground extends React.PureComponent<
  IAutoSlideBackgroundProps
> {
  render() {
    return (
      <div
        className="rps-slide-background"
  ...
  private getBackgroundStyles(): CSSProperties {
    let translateY = 0;
    const { height, parallaxType, parallaxOffset } = this.props;
